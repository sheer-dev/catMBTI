...
export const ResultData = [
  {
    ...
    name: '러시안 블루',
    best: 'ESTJ',
    desc: '겁이 많아요. 워낙 온순한 성격에 조용한 고양이라 소심하게 느껴집니다! 낯을 심하게 가리는 편이고요. 혼자 놔두면 호기심이 많아서 이것저것 치고 건드리고 즐겁게 보내는 고양이 입니다. 초보 애묘가가 키우기 좋은 묘종입니다.',
    image: `${ Russianblue }`
  },
  {
    id: 2,
    name: '샴',
    best: 'ESFP',
    desc: '대체적으로 온순하고 느긋한 성격이예요. 외로움을 잘타며 질투심이 강해요. 수다스러운 성격입니다. 독립심이 강한 편에 속하지만 특이하게도 사람 손 타는 걸 좋아하는 고양이 입니다.',
    image: `${ Siamese }`
  },
  {
    id: 3,
  ...
  },
  {
    ...
    name: '뱅갈',
    best: 'INTP',
    desc: '활동력이 어마어마한 고양이예요! 그렇기 때문에 살이 잘 안찌는 고양이 중에 하나입니다. 집사분이 놀아주다가 탈진할 수도;',
    image: `${ Bengal }`
  },
  {
    id: 5,
  ...
  },
  {
    ...
    name: '아비시니안',
    best: 'ISTJ',
    desc: '민첩하고 호기심 많고 똑똑한 고양이 입니다! 굉장히 수다쟁이여서 집사가 부르면 야옹하고 대답도 잘하는 고양이에요. 물을 굉장히 좋아해서 목욕을 시킬 때, 굉장히 편한 고양이 중 하나! 다만 호기심이 많아서 이것저것 잘 떨어뜨리는 고양이!',
    image: `${ Abyssinian }`
  },
  {
    id: 7,
  ...
  },
  {
    ...
    name: '코리안 숏헤어',
    best: 'ISFP',
    desc: '많은 고양이의 혈통이 섞여있는 고양이예요! 대부분 활발하고 쾌할한 성격을 가지고 있고, 친밀하고 영리합니다! 사냥본능이 매우 뛰어나서 사냥놀이를 굉장히 좋아해요.',
    image: `${ Korshort }`
  },
  {
    id: 10,
    name: '엑죠틱',
    best: 'ISFJ',
    desc: '낯을 가리지 않고, 주인 옆에서 느긋하게 일상을 즐기는 고양이예요! 다만 운동량이 그렇게 많지 않아 뚱뚱 고양이가 될 수 있으니 조심하기!',
    image: `${ Exotic }`
  },
  {
    id: 11,
  ...
  },
  {
    ...
    name: '먼치킨',
    best: 'INFJ',
    desc: '짧은 다리와 귀염한 외모를 가지고 있는 고양이에요! 호기심이 매우 많아서 짧은 다리로 이곳저곳을 돌아다니는 에너지가 넘치는 고양이! 영리하고 애교가 많은 편에 속하는 고양이예요.',
    image: `${ Munchkin }`
  },
  {
    id: 13,
  ...
  },
  {
    ...
    name: '브리티쉬 숏헤어',
    best: 'ENTP',
    desc: '이름과 같이 영국 신사와 같은 고양이! 배려심이 깊고 매우 조용하고 인내심이 강한 고양이예요. 덩치가 큰 편이어서 집사 무릎보다는 옆구리에 앉아서 시간을 보내는 것을 좋아하는 고양이입니다!',
    image: `${ British }`
  },
  {
    id: 15,
